...
+ [Расскажите про виды связей в таблицах](#расскажите-про-виды-связей-в-таблицах)
...
## Расскажите про виды связей в таблицах
Существует три вида связей между таблицами баз данных:											
1. Связь один к одному (одному объекту таблицы А соответствует один объект таблицы Б, и одному объекту таблицы Б соответствует один объект таблицы А. Почти всегда это значит, что нужно объединить таблицы А и Б)											
2. Связь один ко многим (объекту А может принадлежать или же соответствовать несколько объектов Б, но объекту Б может соответствовать только один объект А)											
3. Связь многие ко многим (нескольким объектам из таблицы А может соответствовать несколько объектов из таблицы Б, и в тоже время нескольким объектам из таблицы Б соответствует несколько объектов из таблицы А)											
